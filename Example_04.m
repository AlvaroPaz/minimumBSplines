...
%%%--------------------------
display('Description: Minimum-effort control problem for biped robot walker (using Kelly parameters)')
...
N = 5;    n = 5;   M = 25;
ti = 0;   tf = 0.7;    h = tf/M;    s = linspace(ti,tf,M);
...
L1 = link_len;      L2 = link_len;      L3 = 0.625;      L4 = link_len;      L5 = link_len;
rx1 = 0.128;        rx2 = 0.163;        rx3 = 0.2;       rx4 = 0.163;        rx5 = 0.128;
m1 = 3.2;           m2 = 6.8;           m3 = 20;         m4 = 6.8;           m5 = 3.2;
LL = [L1,L2,L3,L4,L5];
%
...
% % Kelly parameters
qi = [1.65;0.41;-0.61;2.32;0.02];
qf = [1.22;0.02;0.21;3.96;-0.41];
